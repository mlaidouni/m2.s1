...
def init_students(session) :
    ...
    session.execute('drop table if exists students_good')

    #
    # Naïve definition of a student table. Not satisfactory vis à vis performances.
    #
...
if __name__== "__main__":
    ...
    #
    #rows = session.execute('select * from students where uni=\'P5\' allow filtering')
