...
def init_students(session) :
    session.execute('drop table if exists students_tkn')

    #
    # Table definition conceived with a view to optimising performances.
    #
...
if __name__== "__main__":
    ...
    # wrong applications of the token function.
    ...
    # Again on order:
    # by default __rows are ordered by token__
    #
